...
# MAGIC To run this demo, just select the cluster `dbdemos-auto-loader-adwait_dwivedi` from the dropdown menu ([open cluster configuration](https://adb-6868153353610654.14.azuredatabricks.net/#setting/clusters/0602-121351-m48ghl78/configuration)). <br />
...
# MAGIC
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fdata-engineering%2Fauto-loader%2F01-Auto-loader-schema-evolution-Ingestion&cid=6868153353610654&uid=5894390762709745">
